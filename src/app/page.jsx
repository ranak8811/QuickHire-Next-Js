            ...
            {featuredJobs.length > 0 ? (
              featuredJobs.map((job) => (
                <Link 
                  href={`/jobs/${job._id}`} 
                  key={job._id}
                  className="group bg-white p-6 border border-gray/10 rounded-xl hover:border-primary transition-all shadow-sm"
                >
                  <div className="flex justify-between items-start mb-6">
                    ...
                    <span className="px-3 py-1 border border-primary text-primary text-xs font-bold rounded">
                      Full Time
                    </span>
                  </div>
                  ...
                  <p className="text-sm text-gray line-clamp-2 mb-6 h-10">
                    {job.description}
                  </p>
